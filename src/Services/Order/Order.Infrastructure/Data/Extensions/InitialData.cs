...
internal class InitialData
{
    public static IEnumerable<Customer> Customers =>
        new List<Customer>
        {
            Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "Customer 1", "customer1@eshop.com"),
            Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "Customer 2", "customer2@eshop.com")
        };
    ...
    public static IEnumerable<Order.Domain.Models.Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("Customer 1", "C1", "customer1@eshop.com", "Bahcelievler No:4", "DK", "CPH", "CPH", "38050");
            var address2 = Address.Of("Customer 2", "C2", "customer2@eshop.com", "Broadway No:1", "SW", "MALMO", "MALMO", "08050");

            var payment1 = Payment.Of("Customer 1", "5555555555554444", "12/28", "355", 1);
            var payment2 = Payment.Of("Customer 2", "8885555555554444", "06/30", "222", 2);
