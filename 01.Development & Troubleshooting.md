...
- [CSharp.eShop.MicroService.net8](#csharpeshopmicroservicenet8)
  ...
  - [Section 20: Building shopping web client application with Refit HttpClientFactory library (2 hr 45 min)](#section-20-building-shopping-web-client-application-with-refit-httpclientfactory-library-2-hr-45-min)
    ...
    - [328: Install and Configure Refit HttpClientFactory Library in our Shopping.Web ms](#328-install-and-configure-refit-httpclientfactory-library-in-our-shoppingweb-ms)
    - [329 - 331: Develop Service Classes for consume YarpApiGateway with Refit](#329---331-develop-service-classes-for-consume-yarpapigateway-with-refit)
    - [332: Build Presentation Layer: Asp.Net Web Application Razor Pages w/ AspNetRunBasics](#332-build-presentation-layer-aspnet-web-application-razor-pages-w-aspnetrunbasics)
    - [333 - 334: Develop index page, cs and shared pages with Product api consumption via Yarp](#333---334-develop-index-page-cs-and-shared-pages-with-product-api-consumption-via-yarp)
    - [335 - 337: Add to cart and Cart page in web application](#335---337-add-to-cart-and-cart-page-in-web-application)
    - [338 - 339: Developed Product List page in web application](#338---339-developed-product-list-page-in-web-application)
    - [340 - 341: Developed Product Detail page in web application](#340---341-developed-product-detail-page-in-web-application)
    - [342 - 343: Developed Checkout and confirmation page in web application](#342---343-developed-checkout-and-confirmation-page-in-web-application)
    - [344 - 345: Developed Order and contact page in web application](#344---345-developed-order-and-contact-page-in-web-application)
    - [346: TEST - Shopping.Web Client Application using YarpApiGateway Microservices](#346-test---shoppingweb-client-application-using-yarpapigateway-microservices)
    - [347-348: Containerize and Orchestrate Shopping.Web Client Application in Docker-Compose](#347-348-containerize-and-orchestrate-shoppingweb-client-application-in-docker-compose)
...
### 328: Install and Configure Refit HttpClientFactory Library in our Shopping.Web ms

- Added nuget reference of Refit in Shopping.Web project.
- Configured Refit in Program.cs file to use HttpClientFactory and Refit library.
- Added Refit configuration in appsettings.json file to use YarpApiGateway as base address.

### 329 - 331: Develop Service Classes for consume YarpApiGateway with Refit

- Implemented ICatalogService, IBasketService and IOrderService interfaces to consume YarpApiGateway endpoints using Refit library.

### 332: Build Presentation Layer: Asp.Net Web Application Razor Pages w/ AspNetRunBasics

- Download base files, css and js from github repository - [AspNetRunBasics](https://github.com/aspnetrun/run-aspnetcore-basics)
- Replace existing files in Shopping.Web project with downloaded files, especially in wwwroot folder and shared folder.
- This is base and initial UI setup for Shopping.Web project.

### 333 - 334: Develop index page, cs and shared pages with Product api consumption via Yarp

- Added paginated item and top product partial view components.
- Implemented Index.cshtml and Index.cshtml.cs to consume Catalog API via YarpApi
- Run application and validate index page is working correctly with product data.

### 335 - 337: Add to cart and Cart page in web application

- Added Cart.cshtml and Cart.cshtml.cs to consume Basket API via YarpApi.
- Implemented cart functionality in index page to add product to cart.
- Refactored basket service.

### 338 - 339: Developed Product List page in web application

- Added ProductList.cshtml and ProductList.cshtml.cs to consume Catalog API via YarpApi.
- Fixed logger issue in Cart pages.

### 340 - 341: Developed Product Detail page in web application

- Added ProductDetail.cshtml and ProductDetail.cshtml.cs to consume Catalog API via YarpApi.

### 342 - 343: Developed Checkout and confirmation page in web application

- Added Checkout.cshtml and Checkout.cshtml.cs to consume Basket API via YarpApi.
- Added Confirmation.cshtml and Confirmation.cshtml.cs to implement order confirmation functionality.

### 344 - 345: Developed Order and contact page in web application

- Added Order.cshtml and Order.cshtml.cs to consume Order API via YarpApi.
- Added Contact.cshtml and Contact.cshtml.cs to implement contact form functionality.

### 346: TEST - Shopping.Web Client Application using YarpApiGateway Microservices

- Perform end to end testing of Shopping.Web application with YarpApiGateway, Basket, Catalog and Order microservices.

### 347-348: Containerize and Orchestrate Shopping.Web Client Application in Docker-Compose
